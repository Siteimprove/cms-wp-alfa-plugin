...
There are two ways to install the Siteimprove Alfa plugin on WordPress.

To install the plugin via the listing page, type ‘Siteimprove Alfa’ in the search box on the Wordpress plugin listing page and click on ‘install’.

OR

Upload the Siteimprove Alfa plugin zip file using Wordpress’ ‘Upload Plugin’ feature. The plugin can be activated immediately after upload.
