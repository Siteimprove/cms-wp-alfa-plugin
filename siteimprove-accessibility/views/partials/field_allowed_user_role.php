...
<fieldset>
	...
	<p><?php esc_html_e( 'Choose the lowest-level user role that needs access to Siteimprove Accessibility. Roles with higher permissions will also have access.', 'siteimprove_accessibility' ); ?></p>
</fieldset>